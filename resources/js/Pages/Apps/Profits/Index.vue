                            ...
                            <div class="card-body">
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a v-bind:href="`/apps/profits/export?start_date=${start_date}&end_date=${end_date}`"
                                            target="_blank" class="btn btn-success btn-md border-0 shadow me-3"><i
                                                class="fa fa-file-excel"></i> EXCEL</a>
                                        <a v-bind:href="`/apps/profits/pdf?start_date=${start_date}&end_date=${end_date}`"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr v-for="profit in profits" v-bind:key="profit.id">
