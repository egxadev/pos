                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" v-bind:value="product.title"
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" v-bind:value="auth.user.name" readonly>
                                    </div>
                                    <div class="col-md-6 float-end">
                                        <label class="fw-bold">Customer</label>
                                        <VueMultiselect v-model="customer_id" label="name" track-by="name"
                                            v-bind:options="customers"></VueMultiselect>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button @click.prevent="storeTransaction"
                                        ...
                                        v-bind:disabled="cash < grandTotal || grandTotal == 0">Pay Order &
                                        Print</button>
                                </div>
                            </div>
                        </div>
