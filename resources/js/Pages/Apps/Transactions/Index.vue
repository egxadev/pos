                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    ...
                                    <button class="btn btn-success btn-md border-0 shadow text-uppercase mt-3">ADD
                                        ITEM</button>
                                </div>
                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button class="btn btn-purple btn-md border-0 shadow text-uppercase">Pay Order &
                                        Print</button>
                                </div>
                            </div>
                        </div>
