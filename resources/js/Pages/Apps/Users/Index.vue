                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr v-for="(user, index) in users.data" v-bind:key="index">
                                                ...
                                                <td>{{ user.email }}</td>
                                                <td>
                                                    <span v-for="(role, index) in user.roles" v-bind:key="index"
                                                        class="badge badge-primary shadow border-0 ms-2 mb-2">
                                                        {{ role.name }}
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <Link v-bind:href="`/apps/users/${user.id}/edit`"
                                ...
                                <Pagination v-bind:links="users.links" align="end" />
                            </div>
                        </div>
                    </div>
                </div>
