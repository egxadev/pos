                        ...
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr v-for="(customer, index) in customers.data" v-bind:key="index">
                                            <td>{{ customer.name }}</td>
                                            <td>{{ customer.no_telp }}</td>
                                            <td>{{ customer.address }}</td>
                                            <td class="text-center">
                                                <Link v-bind:href="`/apps/customers/${customer.id}/edit`"
                                ...
                                <Pagination v-bind:links="customers.links" align="end" />
                            </div>
                        </div>
                    </div>
                </div>
