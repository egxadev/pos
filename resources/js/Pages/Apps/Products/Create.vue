                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.barcode"
                                                    v-bind:class="{ 'is-invalid': errors.barcode }" type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select"
                                                    v-bind:class="{ 'is-invalid': errors.category_id }"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.title"
                                                    v-bind:class="{ 'is-invalid': errors.title }" type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.stock"
                                                    v-bind:class="{ 'is-invalid': errors.stock }" type="number"
                                                    placeholder="Stock">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.buy_price"
                                                    v-bind:class="{ 'is-invalid': errors.buy_price }" type="number"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.sell_price"
                                                    v-bind:class="{ 'is-invalid': errors.sell_price }" type="number"
